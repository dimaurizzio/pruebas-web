		...
		<div class="cursor"></div>
								...
								<ul class="navbar-nav ms-auto my-5 my-lg-0 navbar-nav-scroll"
									...
									<li class="nav-item dropdown"><a
										...
										<ul class="dropdown-menu"
											...
											<li><a class="dropdown-item disabled" href="#">Alta
													y baja</a></li>
										</ul></li>
								</ul>
							</div>
				...
				<div class="container viewport">
					...
					<article>
						<p class="titulo summer verde">
							temporada verano 2021 <img class="summer-img" src="img\sun.png" /><img
								class="summer-img" src="img\flamingo.png" />
						</p>
					</article>
				</div>
			</section>
			...
			<section class="lista">
				<div class="container viewport">
					<div class="row titular">
						<div class="col-10 titulo">
							...
							<h4 class="subtitulo">Tenemos destinos personalizados para
								tí</h4>
							<a class="btn boton-quiero">Quiero!</a>
						</div>
					...
					<article>
						<p class="politicas">*Promociones validas del 25/08 al 30/12
