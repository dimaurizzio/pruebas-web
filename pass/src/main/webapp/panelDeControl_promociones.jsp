...
<body>
				...
				<div class="contenedor">
					...
					<section class="header" id="home">
						<div class="container">
											...
											<li class="nav-item dropdown"><a class="nav-link nav-a"
												...
												<ul class="dropdown-menu dropdown-menu-end"
													...
													<li><a class="dropdown-item"
														href="personalItinerary.jsp">Itinerario</a></li>
													<li>
							...
							<div class="boton-container justify-content-start">
							<p>Elija su descuento:</p>
								<a data-bs-target="#modalCreatePorcentual"
									data-bs-toggle="modal" class="btn boton-accion" role="button">%<i
									class="ms-2 bi bi-file-earmark-plus font-size"></i>
								</a> <a data-bs-target="#modalCreateAxB" data-bs-toggle="modal"
									class="btn boton-accion" role="button">A x B<i
									class="ms-2 bi bi-file-earmark-plus font-size"></i>
								</a>
								<a data-bs-target="#modalCreateNeto" data-bs-toggle="modal"
									class="btn boton-accion" role="button">Neto<i
									class="ms-2 bi bi-file-earmark-plus font-size"></i>
								</a>
							...
							<table class="table table-stripped table-hover">
								...
								<tbody>
									<c:forEach items="${promotions}" var="promotion">
										<tr
											<c:if test="${promotion.deleted}"> style="background-color: orangered"</c:if>>
											<td><strong>${promotion.nombre}</strong>
												<p>
													<c:out value="${promotion.breveDescripcion}"></c:out>
												</p></td>
											<td><c:out value="${promotion.tipo}"></c:out></td>
											<td>${promotion.tipoP}</td>
											<td><c:forEach items="${promotion.atraccionesDePromo}"
													var="t">
													<c:out value="${t.nombre}"></c:out>
													<br>
												</c:forEach></td>
											<td><c:choose>
					...
					<div class="modal fade" id="modalCreatePorcentual" tabindex="-1"
						...
						<div class="modal-dialog">
							<div class="modal-content">
								<div class="modal-header">
									<h5 class="modal-title" id="ModalC">Ingrese datos del
										usuario</h5>
									<button type="button" class="btn-close" data-bs-dismiss="modal"
										aria-label="Close"></button>
								</div>
								<div class="modal-body">
									<form action="createPromotion" method="get">
										<input type="hidden" for="promotionTipe" name="promotionTipe"
											value="PORCENTUAL">
										<div class="mb-3">
											...
											<div class="mb-3">
												<label for="typeCreate" class="col-form-label">Preferencia:
											...
											<div class="mb-3">
												<label for="attraction1" class="col-form-label">Atraccion
													1: (Elija uno)</label> <select class="form-control"
													id="attraction1" name="attraction1">
											...
											<div class="mb-3">
												<label for="attraction2" class="col-form-label">Atraccion
													2: (Elija uno)</label> <select class="form-control"
													id="attraction2" name="attraction2">
													<c:forEach items="${attractions}" var="attraction">
														<option value="${attraction.nombre}">${attraction.nombre}</option>
													</c:forEach>
												</select>
											...
											<div class="mb-3">
												<label for="discount" class="col-form-label">Descuento
													en %:</label> <input class="form-control" type="number"
													id="discount" name="discount" required></input>
											</div>
											<div class="mb-3">
	...
	<div class="modal fade" id="modalCreateAxB" tabindex="-1"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="ModalAxB">Ingrese datos del
						usuario</h5>
					<button type="button" class="btn-close" data-bs-dismiss="modal"
						aria-label="Close"></button>
				</div>
				<div class="modal-body">
					<form action="createPromotion" method="get">
						<input type="hidden" for="promotionTipe" name="promotionTipe"
							value="AxB">
						<div class="mb-3">
							<label for="nameCreate" class="col-form-label">Nombre:</label> <input
								class="form-control" type="text" id="nameCreate"
								name="nameCreate" required>
							<div class="mb-3">
								<label for="typeCreate" class="col-form-label">Preferencia:
									(Elija uno)</label> <select class="form-control" id="typeCreate"
							...
							<div class="mb-3">
								<label for="attraction1" class="col-form-label">Atraccion
									1: (Elija uno)</label> <select class="form-control" id="attraction1"
									name="attraction1">
									<c:forEach items="${attractions}" var="attraction">
										<option value="${attraction.nombre}">${attraction.nombre}</option>
									</c:forEach>
							...
							<div class="mb-3">
								<label for="attraction2" class="col-form-label">Atraccion
									2: (Elija uno)</label> <select class="form-control" id="attraction2"
									name="attraction2">
									<c:forEach items="${attractions}" var="attraction">
										<option value="${attraction.nombre}">${attraction.nombre}</option>
									</c:forEach>
							...
							<div class="mb-3">
								<label for="free" class="col-form-label">Atraccion
									regalo: (Elija uno)</label> <select class="form-control" id="free"
									name="free">
									<c:forEach items="${attractions}" var="attraction">
										<option value="${attraction.nombre}">${attraction.nombre}</option>
									</c:forEach>
	...
	<div class="modal fade" id="modalCreateNeto" tabindex="-1"
		aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
